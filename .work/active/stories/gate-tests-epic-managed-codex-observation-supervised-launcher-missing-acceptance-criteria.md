---
id: gate-tests-epic-managed-codex-observation-supervised-launcher-missing-acceptance-criteria
kind: story
stage: done
...
# Normalize acceptance criteria for epic-managed-codex-observation-supervised-launcher
...
Contract / risk / regression / maintenance cost: Fifteen checkboxes are under bold acceptance labels that the deterministic heading parser does not recognize. Evidence: `.work/active/features/epic-managed-codex-observation-supervised-launcher.md:166`.
...
`.work/active/features/epic-managed-codex-observation-supervised-launcher.md:166`
