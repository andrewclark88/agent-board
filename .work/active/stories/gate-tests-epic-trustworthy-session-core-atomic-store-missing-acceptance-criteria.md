---
id: gate-tests-epic-trustworthy-session-core-atomic-store-missing-acceptance-criteria
kind: story
stage: done
...
# Normalize acceptance criteria for epic-trustworthy-session-core-atomic-store
...
Contract / risk / regression / maintenance cost: Thirteen checkboxes are under bold acceptance labels that the deterministic heading parser does not recognize. Evidence: `.work/active/features/epic-trustworthy-session-core-atomic-store.md:86`.
...
`.work/active/features/epic-trustworthy-session-core-atomic-store.md:86`
