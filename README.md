...
- Codex 0.147.x, 0.148.x, 0.149.x, 0.150.x, 0.152.x, or 0.153.x
...
- Install a supported Codex 0.147.x, 0.148.x, 0.149.x, 0.150.x, 0.152.x, or
  0.153.x release. `0.151.x` remains unsupported.
